...
class Interception:
    def __init__(self):
        # Keep device handles per instance so filters/events don't bleed across different
        # Interception objects (KeySwallower vs keyboard helpers).
        self._context: list[Device] = []
        self._events = (HANDLE * MAX_DEVICE)()
